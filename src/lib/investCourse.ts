    ...
    units: [
      U("hk-1", "市場同報價", [
        ...
        L(
          ...
          "products",
          30,
          "科技、金融、ETF、藍籌、仙股等分類同風險差異；練習核心＋衛星。",
          [
            "列出至少 4 個分類並各寫一項風險",
            "寫低仙股三大紅旗（紙上權重建議 0）",
            "揀一隻廣基 ETF 做對照筆記",
